/**
 * Prompt sections shared across tiers, kept verbatim from the pre-tiering
 * template so the frontier bundle reproduces the old single prompt byte-for-byte.
 *
...
/** Only mid/low get this — frontier models don't need the reminder. */
...
export const DELIVERING_WORK = `# Delivering work
