...
<p align="center">
  <img src="https://raw.githubusercontent.com/IsuruMaduranga/one-code/master/demo/onecode.gif" alt="One Code: permission modes, a mid-session model switch, an agentic edit approved by auto mode, a /btw side question, /doctor report, and a subagent in the live panel" width="820">
</p>

[User guide](https://github.com/IsuruMaduranga/one-code/blob/master/docs/guide/README.md) ·
[Bring your Claude Code setup](https://github.com/IsuruMaduranga/one-code/blob/master/docs/guide/bring-your-claude-code-setup.md) ·
...
optional, PowerShell tool) — see the [Windows guide](https://github.com/IsuruMaduranga/one-code/blob/master/docs/guide/windows.md).
...
and your provider. See [Providers and models](https://github.com/IsuruMaduranga/one-code/blob/master/docs/guide/providers-and-models.md)
...
[Subagents and workflows →](https://github.com/IsuruMaduranga/one-code/blob/master/docs/guide/subagents-and-workflows.md)
...
[Configuration details →](https://github.com/IsuruMaduranga/one-code/blob/master/docs/guide/bring-your-claude-code-setup.md) ·
[Skills, plugins, and MCP →](https://github.com/IsuruMaduranga/one-code/blob/master/docs/guide/skills-plugins-and-mcp.md)
...
[Permissions and modes →](https://github.com/IsuruMaduranga/one-code/blob/master/docs/guide/permissions-modes-and-auto-mode.md) ·
[Hooks →](https://github.com/IsuruMaduranga/one-code/blob/master/docs/guide/hooks.md)
...
See [Tools](https://github.com/IsuruMaduranga/one-code/blob/master/docs/guide/tools.md) for every tool the model can call and the
[command reference](https://github.com/IsuruMaduranga/one-code/blob/master/docs/guide/reference.md) for every command, shortcut, flag,
and environment variable.

## 📚 Documentation

The [user guide](https://github.com/IsuruMaduranga/one-code/blob/master/docs/guide/README.md) covers everything: installation,
...
[MIT](https://github.com/IsuruMaduranga/one-code/blob/master/LICENSE). Contributions welcome.
