...
<p align="center">
  <img src="https://raw.githubusercontent.com/IsuruMaduranga/one-code/master/demo/onecode.gif" alt="One Code terminal showing permission modes, a model switch, an approved edit, a side question, diagnostics, and a running subagent" width="820">
</p>

[User guide](https://github.com/IsuruMaduranga/one-code/blob/master/docs/guide/README.md) ·
[Reuse your Claude Code setup](https://github.com/IsuruMaduranga/one-code/blob/master/docs/guide/bring-your-claude-code-setup.md) ·
[Differences from Claude Code](https://github.com/IsuruMaduranga/one-code/blob/master/docs/guide/differences-from-claude-code.md) ·
[Command reference](https://github.com/IsuruMaduranga/one-code/blob/master/docs/guide/reference.md)
...
see the [Windows guide](https://github.com/IsuruMaduranga/one-code/blob/master/docs/guide/windows.md).

One Code is free under the MIT license. Model access, usage charges, and rate
limits depend on your provider. See
[Providers and models](https://github.com/IsuruMaduranga/one-code/blob/master/docs/guide/providers-and-models.md) for connection options.
...
[installation guide](https://github.com/IsuruMaduranga/one-code/blob/master/docs/guide/installation.md) for display settings and more
...
- **Inspect and change the code.** The project is open source under the
  [MIT license](https://github.com/IsuruMaduranga/one-code/blob/master/LICENSE).
...
See [Differences from Claude Code](https://github.com/IsuruMaduranga/one-code/blob/master/docs/guide/differences-from-claude-code.md)
...
you delegate. See [Subagents and workflows](https://github.com/IsuruMaduranga/one-code/blob/master/docs/guide/subagents-and-workflows.md)
...
See [Configuration compatibility](https://github.com/IsuruMaduranga/one-code/blob/master/docs/guide/bring-your-claude-code-setup.md)
and [Skills, plugins, and MCP](https://github.com/IsuruMaduranga/one-code/blob/master/docs/guide/skills-plugins-and-mcp.md).
...
[Permissions and modes](https://github.com/IsuruMaduranga/one-code/blob/master/docs/guide/permissions-modes-and-auto-mode.md) for
guarantees and known limitations, and [Hooks](https://github.com/IsuruMaduranga/one-code/blob/master/docs/guide/hooks.md) for
hook configuration.
...
See [Tools](https://github.com/IsuruMaduranga/one-code/blob/master/docs/guide/tools.md) for available tools and the
[command reference](https://github.com/IsuruMaduranga/one-code/blob/master/docs/guide/reference.md) for commands, shortcuts, flags,
...
The [user guide](https://github.com/IsuruMaduranga/one-code/blob/master/docs/guide/README.md) covers setup, configuration, providers,
...
[MIT](https://github.com/IsuruMaduranga/one-code/blob/master/LICENSE). Contributions are welcome.
